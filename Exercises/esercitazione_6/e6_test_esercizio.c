...
int main(int argc, char **argv) {
	...
	//vec_integral
	int vec_size = 10;
	float vec[10] = {4.1, -2.3, 5.8, 1.4, -0.3, 4.9, 9.1, -3.7, 2.9, -4.9};
	float vec_sol[10] = {4.1, -2.3, 5.8, 1.4, -0.3, 4.9, 9.1, -3.7, 2.9, -4.9};
	...
	//vec_dot
	int vecs_size = 5;
	float vec1[5] = {5.7, 2.3, -4.6, 8.1, -0.1};
	float vec2[5] = {-5.2, 1.3, -2.1, 11.2, 0.1};
